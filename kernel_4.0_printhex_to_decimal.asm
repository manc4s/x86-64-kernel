...
;;move to esi the value to print as mov esi, [value to print].
;;value must be a 32 bit dd at location. print_hex_ads_decimal grabs 4bytes at location byt moving it to esi
...
;;location of byte to print is passed to esi as mov esi, value
